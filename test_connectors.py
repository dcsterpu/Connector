...
class ConnectorDescriptor(unittest.TestCase):
    ...
    def test_TRS_CONNECTOR_CHECK_003_3(self):
        current_path = os.path.realpath(__file__)
        head, tail = ntpath.split(current_path)
        os.system('ConnectorDescriptor.py -config ' + head + '\\tests\TRS.CONNECTOR.CHECK.003_3\\ConfigConnectorDescriptor.xml')
    ...
    def test_TRS_CONNECTOR_CHECK_004_4(self):
        current_path = os.path.realpath(__file__)
        head, tail = ntpath.split(current_path)
        os.system('ConnectorDescriptor.py -config ' + head + '\\tests\TRS.CONNECTOR.CHECK.004_4\ConfigConnectorDescriptor.xml')
    ...
    def test_TRS_CONNECTOR_CHECK_004_5(self):
        current_path = os.path.realpath(__file__)
        head, tail = ntpath.split(current_path)
        os.system('ConnectorDescriptor.py -config ' + head + '\\tests\TRS.CONNECTOR.CHECK.004_5\ConfigConnectorDescriptor.xml')
